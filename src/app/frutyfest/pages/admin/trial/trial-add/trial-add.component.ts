...
export class TrialAddComponent {
  ...
  public myForm: FormGroup = this.fb.group({
    name: ['Nombre del modo de juego', [Validators.required, Validators.minLength(1)]],
  ...
  addTrial(): void {
    ...
    this.frutyfestService.addTrial(name, maxPoints, pointsDecrease, maxTeams)
      .subscribe({
        next: (team) => {
          Swal.fire('Creación', 'Creación del modo de juego correcta', 'success')
